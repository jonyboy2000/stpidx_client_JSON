...
//	    console.log ("URL param="+url);	    
	...
	LOADER.addRequest(url, function(json) {
	    ...
	    var root_el = json.step_assembly;

	    if (root_el.save != null) {
		    var save_el = root_el.save;

		    if (!root_id)
		        root_id = root_el["-root"];
		    ...
		    LOADER.addRequest(url, function(json) {
		        ...
		        Assembly.init(viewer, tree_el, root_el,
