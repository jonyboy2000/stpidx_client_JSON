/* $RCSfile: Shape.js,v $
 * $Revision: 1.17 $ $Date: 2012/11/07 21:11:12 $
...
function Shape(builder, id)
{
	...
	for (var i=0; i<shells.length; i++) {
	    var sh = new Shell(builder, shells[i]);
	    if (sh == null)
		continue;
	    this.shells.push(sh);
	}
    }
    var annotation_ids = el.annotation;
    this.annotations = [];
    if (annotation_ids) {
...
METHODS (Shape, {
	...
	var i;
	var bbox = new BoundingBox(); //added ()
